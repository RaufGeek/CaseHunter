...
const casesData = [
    ...
    {'id': 'swisswatch', 'name': 'Swiss Watch Box', 'imageFilename': 'https://images.casehunter.sbs/SwissWatchDayTrader.png', 'priceTON': 6.0, 'prizes': [
            ...
            { 'name': 'Top Hat', 'probability': 0.05, 'img_url': 'https://images.casehunter.sbs/TopHatCardinal.png' },
    ...
    {'id': 'black_only_case', 'name': 'Black Only', 'imageFilename': 'https://images.casehunter.sbs/BackgroundEraser_20250908_000116933.png', 'priceTON': 16.0, 'prizes': [
            {'name': 'Plush Pepe', 'probability': 1e-06, 'img_url': 'https://images.casehunter.sbs/PlushPepe.png'},
            {'name': "Durov's Cap", 'probability': 5e-06, 'img_url': "https://images.casehunter.sbs/Durov'sCap.png"},
            {'name': 'Precious Peach', 'probability': 1e-05, 'img_url': 'https://images.casehunter.sbs/PreciousPeach.png'},
            {'name': 'Nail Bracelet', 'probability': 5e-05, 'img_url': 'https://images.casehunter.sbs/NailBracelet.png'},
            {'name': 'Astral Shard', 'probability': 0.0001, 'img_url': 'https://images.casehunter.sbs/AstralShard.png'},
            {'name': 'Perfume Bottle', 'probability': 0.0005, 'img_url': 'https://images.casehunter.sbs/PerfumeBottle.png'},
            {'name': 'Swiss Watch', 'probability': 0.001, 'img_url': 'https://images.casehunter.sbs/SwissWatch.png'},
            {'name': 'Vintage Cigar', 'probability': 0.001, 'img_url': 'https://images.casehunter.sbs/VintageCigar.png'},
            {'name': 'Sharp Tongue', 'probability': 0.002, 'img_url': 'https://images.casehunter.sbs/SharpTongue.png'},
            {'name': 'Electric Skull', 'probability': 0.002, 'img_url': 'https://images.casehunter.sbs/ElectricSkull.png'},
            {'name': 'Record Player', 'probability': 0.05, 'img_url': 'https://images.casehunter.sbs/RecordPlayer.png'},
            {'name': 'Voodoo Doll', 'probability': 0.05, 'img_url': 'https://images.casehunter.sbs/VoodooDoll.png'},
            {'name': 'Top Hat', 'probability': 0.05, 'img_url': 'https://images.casehunter.sbs/TopHat.png'},
            {'name': 'Skull Flower', 'probability': 0.1, 'img_url': 'https://images.casehunter.sbs/SkullFlower.png'},
            {'name': 'Spy Agaric', 'probability': 0.1, 'img_url': 'https://images.casehunter.sbs/SpyAgaric.png'},
            {'name': 'Hypno Lollipop', 'probability': 0.2, 'img_url': 'https://images.casehunter.sbs/HypnoLollipop.png'},
            {'name': 'Desk Calendar', 'probability': 0.193334, 'img_url': 'https://images.casehunter.sbs/DeskCalendar.png'},
            {'name': 'Lol Pop', 'probability': 0.25, 'img_url': 'https://images.casehunter.sbs/LolPop.png'}]},
...
function initFortune() {
    ...
    function updateBalance(newBalance) {
        ...
        balanceElements.forEach(el => {
            if (el) el.textContent = Math.floor(newBalance);
        });
    }
